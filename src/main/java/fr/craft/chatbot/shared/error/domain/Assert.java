...
import fr.craft.chatbot.shared.nullness.domain.Contract;
import fr.craft.chatbot.shared.nullness.domain.EnsuresNonNull;
...
public final class Assert {
   ...
   */
  @Contract("_, null -> fail")
  public static void notEmpty(String field, @Nullable Map<?, ?> map) {
    notNull(field, map);
