package fr.craft.chatbot.shared.collection.domain;
...
@UnitTest
class ChatbotCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class ChatbotCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = ChatbotCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = ChatbotCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class ChatbotCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = ChatbotCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = ChatbotCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class ChatbotCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = ChatbotCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = ChatbotCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class ChatbotMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = ChatbotCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = ChatbotCollections.immutable(input);
